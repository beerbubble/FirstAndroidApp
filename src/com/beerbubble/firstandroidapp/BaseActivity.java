...
public class BaseActivity extends SlidingFragmentActivity {
	...
	public void setContentView(int layoutResID) {
		...
		final View baseactivity_threepart = factory.inflate(
				R.layout.baseactivity_threepart, null);

		final RelativeLayout body_Layout = (RelativeLayout) baseactivity_threepart
		...
		home_layout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				home_text
						.setTextColor(getResources().getColor(R.color.menutab));
		...
		menu_layout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				FragmentTransaction transaction = fragmentManager
						.beginTransaction();
				transaction.add(R.id.content, new MenuFragment());
				transaction.commit();
			}
		});
		...
		stores_layout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				stores_text.setTextColor(getResources().getColor(
						R.color.menutab));
